...
Question5=Label(root, text = "Do you experience persistent wheezizng/coughing that produces white or pink blood tinged mucus")
Question5.pack()
...
btn = Button(root, text = "submit",command = fever_score)
btn.pack()
root.mainloop()